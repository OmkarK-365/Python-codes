...
while True:
	...
	elif (("run" in p) or ("open" in p) or ("execute" in p) or ("start" in p)) and (("powershell" in p) or ("windows powershell" in p) or ("power shell" in p) or ("windows power shell" in p)):	
		if ("powershell" in p):
			os.system("start powershell")
			print("Opening PowerShell")
		elif ("windows powershell" in p):
			os.system("start powershell")
			print("Opening Windows PowerShell")
		elif ("power shell" in p):
			os.system("start powershell")
			print("Opening Power Shell")
		elif ("windows power shell" in p):
			os.system("start powershell")
			print("Opening Windows Power Shell")

	elif (("run" in p) or ("open" in p) or ("execute" in p) or ("start" in p)) and (("magnify" in p) or ("magnifier" in p) or ("screen magnifier" in p)):	
		if ("magnify" in p):
			...
			os.system("start magnify")
			print("Opening Magnifier")
		elif ("screen magnifier" in p):
			os.system("start magnify")
			print("Opening Screen Magnifier")
		
	elif (("run" in p) or ("open" in p) or ("execute" in p) or ("start" in p)) and (("narrator" in p) or ("reader" in p) or ("screen reader" in p)):	
		if ("narrator" in p):
			os.system("start narrator")
			print("Opening Narrator")
		elif ("reader" in p):
			os.system("start narrator")
			print("Opening Reader")
		elif ("screen reader" in p):
			os.system("start narrator")
			print("Opening Screen Reader")
	...
	elif (("run" in p) or ("open" in p) or ("execute" in p) or ("start" in p)) and (("taskmanager" in p) or ("processes" in p) or ("task manager" in p) or ("taskmgr" in p)):	
		if ("taskmanager" in p):
	...
	elif (("shutdown" in p) or ("poweroff" in p) or ("power off" in p)):
		if ("shutdown" in p):
			os.system("shutdown/s")
			print("Shutting Down The PC")
		elif ("poweroff" in p):
			os.system("shutdown/s")
			print("Powering Off The PC")
		elif ("power off" in p):
			os.system("shutdown/s")
			print("Powering Off The PC")

	elif (("restart" in p) or ("reboot" in p)):
		if ("restart" in p):
	...
	elif (("run" in p) or ("open" in p) or ("execute" in p) or ("start" in p)) and (("unzipper" in p) or ("unzip tool" in p) or ("winrar" in p) or ("7zip" in p)):
		if ("unzipper" in p):
			os.system("start winrar")
			print("Opening Unzipper")
		elif ("unzip tool" in p):
			os.system("start winrar")
			print("Opening Unzip Tool")
		elif ("winrar" in p):
			os.system("start winrar")
